...
/**
 * Schedule a local notification for a plant at 9:00 AM on its next_water_date (YYYY-MM-DD).
...
export const schedulePlantNotification = async (plant) => {
  try {
    ...
    // Parse local YYYY-MM-DD date set to 9:00 AM
    let scheduledTime = parseLocalDateStringTo9AM(plant.nextWaterDate);
